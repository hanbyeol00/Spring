package com.han.mybooks.service.impl;
...
import com.han.mybooks.config.NaverSecret;
import com.han.mybooks.models.BookDto;
import com.han.mybooks.service.NaverBookService;
...
public class NaverServiceImplV1 implements NaverBookService{
	...
	public List<BookDto> getNaverBooks(String queryURL) {
		...
		headers.set("X-Naver-Client-id", NaverSecret.CLAIENT_ID);
		headers.set("X-Naver-Client-Secret", NaverSecret.CLAIENT_SECRET);
