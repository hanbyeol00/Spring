...
public class ArrayV1 {
	...
	public static void main(String[] args) {
		...
		// 실수(float)형 데이터 10개를 저장할 배열 nums2 를 만든다
		 ...
		 * 만약 nums1 에 새로운 20개의 배열을 생성하는 명령이 수행되면
		 * 기존의 nums1 의 배열은 사라지고 새로운 20개 배열이 생성되고
		...
		// ArrayIndexOutOfBounds exception 이 발생한다
		nums1[20] = 100;
